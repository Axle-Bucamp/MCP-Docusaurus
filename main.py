...
@app.tool(name="health_check", description="Check if the service is up")
async def health_check() -> dict:
    """Health check endpoint to verify service status."""
    return {"status": "ok", "service": "mcp-docusaurus"}

@app.tool(name="metrics", description="Return metrics for the service")
...
@app.tool(name="create_document", description="Create a new documentation entry")
...
@app.tool(name="update_docs", description="Update a document at the given position")
...
@app.tool(name="continue_docs", description="Continue writing the document at end")
...
@app.tool(name="get_docs", description="Get the content of a document at a given path")
...
@app.tool(name="unfinished_docs", description="Get all the unfinished documents")
...
@app.tool(name="search_docs", description="Search knowledge in documentation embeddings")
